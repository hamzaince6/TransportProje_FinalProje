...
{
    public partial class KaraSoforTablosuGuncelle : Form
    {
        public KaraSoforTablosuGuncelle()
        {
            InitializeComponent();
        }
        ...
        {
            KaraSoforTablosu form122 = new KaraSoforTablosu();
            form122.Show();
            this.Hide();
        ...
        private void KaraSoforTablosuGuncelle_Load(object sender, EventArgs e)
        {
