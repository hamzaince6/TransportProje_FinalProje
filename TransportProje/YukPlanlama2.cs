...
{
    public partial class YukPlanlama2 : Form
    {
        public YukPlanlama2()
        {
            InitializeComponent();
        ...
        private void YukPlanlama2_Load(object sender, EventArgs e)
        {
            //Buton6 Gizleme
        ...
        public void SoforListele()
        {
            try
            {
                ...
                string Sorgu = "Select *from ihraacat "; //Sql Komutunu yaz
                OleDbDataAdapter da = new OleDbDataAdapter(Sorgu, Baglanti);
                da.Fill(ds, "ihraacat");
                datagridihraacat.DataSource = ds.Tables["ihraacat"]; //ihraacat Takip tablosunu formda gösterdik
                Baglanti.Close();
            ...
            catch (Exception Hata)
            {
                ...
                MessageBox.Show(Hata.Message, "ihraacat Listele Hata Penceresi");
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int seciliSatirId = Convert.ToInt32(datagridihraacat.CurrentRow.Cells["Kimlik"].Value);
            ...
            using (OleDbConnection conn = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=Data.accdb;"))
            {
                ...
                using (OleDbCommand cmd = new OleDbCommand("DELETE FROM ihraacat WHERE Kimlik = @Kimlik", conn))
                {
            ...
            datagridihraacat.Rows.Remove(datagridihraacat.CurrentRow);
        }
        ...
        public void KayitEkle()
        {
            try
            {
                ...
                string Sorgu = "Insert Into ihraacat (YukNo,GondericiFirma,AliciFirma,YuklemeYeri,BosaltmaYeri,TasimaSekli,PozisyonTipi,CekiciPlaka,SurucuAdi) Values (@YukNo,@GondericiFirma,@AliciFirma,@YuklemeYeri,@BosaltmaYeri,@TasimaSekli,@PozisyonTipi,@CekiciPlaka,@SurucuAdi)";
        ...
        private void radyukno_CheckedChanged(object sender, EventArgs e)
        {
        ...
        public void SoforHizliAra()
        {
            try
            {
                ...
                string SorguTumKayitlar = "select * from ihraacat";
                string SorguBayiilebaslayan = "Select * From ihraacat where YuklemeYeri Like '" + txtAranan.Text + "%'";
                string SorguBayiilebiten = "Select * From ihraacat where YuklemeYeri Like '%" + txtAranan.Text + "'";
                string SorguBayiiceren = "Select * From ihraacat where YuklemeYeri Like '%" + txtAranan.Text + "%'";

                string SorguMalindegerilebaslayan = "Select * From ihraacat where YukNo Like '" + txtAranan.Text + "%'";
                string SorguMalındegerilebiten = "Select * From ihraacat where YukNo Like '%" + txtAranan.Text + "'";
                string SorguMalındegericeren = "Select * From ihraacat where YukNo Like '%" + txtAranan.Text + "%'";
                ...
                da.Fill(ds, "ihraacat");
                datagridihraacat.DataSource = ds.Tables["ihraacat"];
                Baglanti.Close();
            }
            catch (Exception Hata)
            {
        ...
        private void radyuklemeyeri_CheckedChanged(object sender, EventArgs e)
        {
            lblAlanalan.Text = "Yukleme Ülkesi :";
            txtAranan.Focus();
            txtAranan.Text = "";
        }
    }
