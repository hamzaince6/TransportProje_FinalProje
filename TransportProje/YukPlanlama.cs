...
{
    public partial class YukPlanlama : Form
    {
        public YukPlanlama()
        {
            InitializeComponent();
        ...
        private void YukPlanlama_Load(object sender, EventArgs e)
        {
            //Buton6 Gizleme
        ...
        {
            YukPlanlama1 frmyuk1 = new YukPlanlama1();
            frmyuk1.Show();
            this.Hide();
        }
        ...
        {
            YukPlanlama2 frmyuk2 = new YukPlanlama2();
            frmyuk2.Show();
            this.Hide();
        }
    }
